...
Fingerprint: the index page names AnythingLLM, or GET /api/ping answers
{"online": true}. Default single-user mode has NO auth at all: anyone who
reaches it can use your models, read your uploaded documents and change
settings. CRITICAL when the app answers unauthenticated.
"""
